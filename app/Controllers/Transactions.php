...
class Transactions extends BaseController
{
    ...
    {
        $dataForFilter = $this->request->getPost('filter');

        $transactionModel = new TransactionsModel();
        $transactionsFiltered = $transactionModel->filterTransactions($dataForFilter);

        $data['transactions'] = $transactionsFiltered;

        if ($transactionsFiltered) {
            return redirect()->to('transactions')->with('transactionsFiltered', $data);
        }
    }
}
